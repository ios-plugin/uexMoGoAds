...
#import "AdMoGoAdapterDMbSplash.h"
...
@implementation AdMoGoAdapterDMbSplash
...
- (void)getAd{
    ...
    if ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad) {
        adSize = DB_AD_SIZE_768x576;
        offset = 374.0f;
    } else {
        adSize = DB_AD_SIZE_320x240;
    ...
    _splashAd = [[DMSplashAdController alloc] initWithPublisherId:pubID
                                                      placementId:placementId
                                                           window:[splashAds getWindow]];
    ...
    if (_splashAd.isReady)
    {
        ...
        // 芒果调用多盟开屏展示
        [_splashAd dbSplashAdImpression];
    }else{
...
#pragma mark DMSplashAdControllerDelegate
